...
angular.module('IOne-Production').controller('OCMChannelController', function ($scope, OCMChannelService, Constant, $mdDialog, $q) {
    $scope.pageOption = {
        sizePerPage: 10,
        currentPage: 0,
        totalPage: 100,
    ...
    $scope.refreshList = function () {
        OCMChannelService.getAll($scope.pageOption.sizePerPage, $scope.pageOption.currentPage, $scope.listFilterOption.confirm, $scope.listFilterOption.status, $scope.listFilterOption.no, $scope.listFilterOption.name, $scope.listFilterOption.channelFlag).success(function (data) {
