...
angular.module('IOne-Production').controller('CBIReturnReasonController', function ($scope, CBIReturnReasonService, Constant, $mdDialog, $q) {
    ...
    $scope.refreshList = function () {
        CBIReturnReasonService.getAll($scope.pageOption.sizePerPage, $scope.pageOption.currentPage, $scope.listFilterOption.confirm, $scope.listFilterOption.status, $scope.listFilterOption.no, $scope.listFilterOption.name).success(function (data) {
