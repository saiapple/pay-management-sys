angular.module('IOne-login').service('AuthenticationService', function (Base64, $http, $cookieStore, $rootScope) {
    ...
    this.SetCredentials = function (username, password, loginResponse) {
        ...
        $cookieStore.put('role', loginResponse.role);
    };
...
angular.module('IOne-login').service('Base64', function () {
